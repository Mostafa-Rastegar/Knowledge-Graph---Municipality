...
این یعنی عدد Dev کمی خوش‌بینانه است. راه درست، یک اجرای واحد روی Test با پیکربندی قفل‌شده است؛ این اجرا در مرحله‌ی سوم (بخش ۷٫۸) با همین پیکربندی در جریان است و عددش پس از تکمیل گزارش می‌شود.
...
پیکربندی در این مرحله **قفل** شد: همان دو پرامپت، همان دو مثال، همان هستان‌شناسی و همان سه قاعده‌ی مرحله‌ی قبل، بدون هیچ تنظیم تازه‌ای. ترتیب اجرا: بخش Dev (۹۹۸ سند)، بخش Test (۱٬۰۰۰ سند DocRED به‌اضافه‌ی ۵۰۰ سند Re-DocRED با برچسب بازبینی‌شده)، بخش Train برچسب‌خورده (۳٬۰۵۳ سند)، و در پایان بخش نظارت‌ازدور (۱۰۱٬۸۷۳ سند).

**۷.۸.۱ بخش Dev کامل، ۹۹۸ سند، برچسب‌های اصلی DocRED.** ۱۲٬۲۷۵ سه‌تایی طلایی، ۹۶ رابطه.

| نسخه | سه‌تایی خروجی | Precision | Recall | **F1** | Ign F1 |
|---|---:|---:|---:|---:|---:|
| گذر A — بدون مثال | ۱۲٬۰۱۹ | ۱۹٫۶۹ | ۱۹٫۲۸ | ۱۹٫۴۹ | ۱۹٫۷۸ |
| گذر B — دو مثال | ۹٬۷۹۶ | **۲۳٫۲۴** | ۱۸٫۵۵ | ۲۰٫۶۳ | ۲۰٫۵۶ |
| **اجماع A+B + لایه‌ی بستار** | ۲۰٬۹۰۳ | ۱۶٫۹۷ | **۲۸٫۹۰** | **۲۱٫۳۸** | ۲۰٫۱۱ |

الگوی مرحله‌ی قبل تکرار شد: مثال دقت را می‌خرد (۱۹٫۶۹ ← ۲۳٫۲۴)، اجماع و قاعده بازخوانی را (۱۸٫۵۵ ← ۲۸٫۹۰). ولی سطح دقت به‌طور کلی پایین‌تر از مرحله‌ی قبل است، و علتش مدل نیست.
...
|---|---:|---:|---:|---:|---:|
| DocRED اصلی | ۶٬۱۴۱ | ۱۶٫۷۹ | ۲۸٫۱۴ | ۲۱٫۰۳ | ۱۹٫۹۱ |
| Re-DocRED بازبینی‌شده | **۱۷٬۱۸۳** | **۳۵٫۵۶** | ۲۱٫۲۹ | **۲۶٫۶۴** | ۲۶٫۰۰ |

برچسب‌های بازبینی‌شده ۲٫۸ برابر بیشترند و دقت اندازه‌گیری‌شده‌ی همان پیش‌بینی‌ها **دو برابر** می‌شود. یعنی نیمی از «مثبت‌های کاذب» روی برچسب اصلی، رابطه‌هایی هستند که در متن وجود دارند و فقط برچسب نخورده‌اند. این عدد، همان ادعای مقاله‌ی Re-DocRED است که اینجا با سامانه‌ی ما مستقیماً اندازه‌گیری شد. نتیجه‌ی عملی برای خواندن جدول‌های این گزارش: هر عدد دقت روی برچسب اصلی DocRED یک **کران پایین** است.

**۷.۸.۳ گراف در مقیاس تازه.** خروجی ۹۹۸ سند با بارگذار دسته‌ای در همان Neo4j بار شد: ۲۳٬۹۲۷ رابطه در ۱۵ ثانیه. پایگاه اکنون ۱۱٬۹۴۳ گره‌ی موجودیت، ۲۸٬۷۸۳ یال و ۳۶٬۴۰۲ گره‌ی شاهد دارد. کشیدن همه‌ی این‌ها با هم معنا ندارد، پس رابط وب یک جست‌وجوی موجودیت گرفت: نام را می‌نویسید و همسایگی آن با شاهد هر یال می‌آید. نمونه‌ی زیر همسایگی `Tehran` است؛ پنل سمت چپ جمله‌ی منبع هر رابطه را نشان می‌دهد و سربرگ، اندازه‌ی کل پایگاه را.

![جست‌وجوی موجودیت در گراف ۹۹۸ سند](graph_docred_search.png)

**۷.۸.۴ بخش‌های باقی‌مانده.** اجرای بخش Test، بخش Train برچسب‌خورده و بخش نظارت‌ازدور با همین پیکربندی قفل‌شده در جریان است؛ اجرا ازسرگیری‌پذیر است و نتیجه‌ی هر بخش با تکمیلش به همین بخش اضافه می‌شود. ۳۲۶ سند نخست بخش Test پیش از توقف موقتِ سرویس مدل زبانی استخراج شده و کش شده‌اند.
...
۱. عددهای اصلی روی بخش Dev گزارش شده‌اند: ۵۰۰ سند با برچسب بازبینی‌شده (بخش ۷٫۶) و ۹۹۸ سند با برچسب اصلی (بخش ۷٫۸). اجرای بخش Test با پیکربندی قفل‌شده در جریان است و عدد آن پس از تکمیل به بخش ۷٫۸ اضافه می‌شود.
۶. برچسب‌های اصلی DocRED ناقص‌اند و دقت را حدود دو برابر کمتر از واقع نشان می‌دهند (بخش ۷٫۸٫۲). برچسب بخش نظارت‌ازدور از این هم نویزی‌تر است؛ عدد آن بخش «توافق» است، نه دقت.
