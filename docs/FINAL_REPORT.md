...
سامانه روی بنچمارک استاندارد Re-DocRED ارزیابی شد. در شش تکرار، F1 از ۱۶٫۸۸ به **۲۹٫۶۶** رسید (۷۶٪ رشد نسبی)، در حالی که خط‌مبنای zero-shot منتشرشده با GPT-3.5 روی همین دیتاست ۹٫۷۴ است. سه عامل این رشد را ساختند: مثال کاری در پرامپت که دقت را ۲۴٪ بالا برد، لایه‌ی بستار قاعده‌محور، و اجماع چند گذر مستقل. سپس همان مدل بدون تغییر معماری روی اسناد فارسی شهرداری اجرا شد و به‌عنوان مطالعه‌ی موردی ایرانی گزارش شد.
...
| سامانه‌ی ما (v3) | zero-shot، بدون هیچ مثالی | ۲۳٫۵۵ |
| **سامانه‌ی ما (v6)** | **دو مثال در پرامپت + اجماع سه گذر** | **۲۹٫۶۶** |
...
۱. ارزیابی روی زیرمجموعه‌ی بخش Dev انجام شد، نه کل ۵۰۰ سند. علت هزینه و زمان فراخوانی مدل زبانی است. خط لوله برای اجرای کامل آماده است.
